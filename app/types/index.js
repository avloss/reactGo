...
export const GET_MASSEUSES_REQUEST = 'GET_MASSEUSES_REQUEST';
export const GET_MASSEUSES_SUCCESS = 'GET_MASSEUSES_SUCCESS';
export const GET_MASSEUSES_FAILURE = 'GET_MASSEUSES_FAILURE';

export const OPEN_MASSEUSE_MODAL = 'OPEN_MASSEUSE_MODAL';
export const CLOSE_MASSEUSE_MODAL = 'CLOSE_MASSEUSE_MODAL';